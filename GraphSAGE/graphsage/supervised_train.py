...
from graphsage.supervised_models import SupervisedGraphsage, SupervisedPGE
from graphsage.models import SAGEInfo
from graphsage.minibatch import NodeMinibatchIterator,WeightedNodeMinibatchIterator
from graphsage.neigh_samplers import UniformNeighborSampler,WeightedNeighborSampler
...
def train(train_data,CModel,centroids, test_data=None):
    ...
    # Init variables #changes remove adj weight in feed_dict
    sess.run(tf.global_variables_initializer(), feed_dict={adj_info_ph: minibatch.adj,adj_weight_ph: minibatch.adj_weight})
...
def main(argv=None):
    ...
    ## My changes
    path='/home/thummala/graph-datasets/ppi_extra/ppi.skl'
    CModel = joblib.load(path)
    centroids=np.load('/home/thummala/graph-datasets/ppi_extra/centroids.npy')
    ## My changes end
    train(train_data,CModel,centroids)
